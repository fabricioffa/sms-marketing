                    ...
                    <div class="bg-edeef0 rounded-30 py-4 mb-5">
                        <div
                            ...
                            <div class="text-start text-sm-center text-lg-start">
                                ...
                                <p class="fw-light text-1415 pb-2 mb-5">A API de conexão HTTP permite integrar a sua aplicação com o nosso Gateway para o envio de SMS, utilizando o protocolo HTTP ou HTTPS ( para transações seguras através de criptografia SSL). Ambos os pedidos e as respostas são feitas API REST em formato JSON, tornando muito simples de usar API com qualquer linguagem de programação.</p>
                                <a class="fs-18 fw-500 text-white bg-secondary rounded-4 text-decoration-none py-3 px-5" href="" role="button">Ver documentação</a>
                            </div>
                    ...
                    <div class="bg-edeef0 rounded-30 py-4 mb-5">
                        <div
                            ...
                            <div class="col-lg-5 text-start text-sm-center text-lg-start">
                                ...
                                <p class="fw-light text-1415 pb-2 mb-5">A API de integração HTTP através de GET é a API de integração mais simples para o envio de SMS. Por norma, esta implementação é muito rápida e fácil, suportando uma ampla gama de tipos de mensagens e de funcionalidades. Devido ao seu tempo de integração, apenas é necessário um equipamento informático no qual possa executar o script ou a aplicação e um navegador ou um ferramenta http.</p>
                                <a class="fs-18 fw-500 text-white bg-secondary rounded-4 text-decoration-none py-3 px-5" href="" role="button">Ver documentação</a>
                            </div>
                    ...
                    <div class="bg-edeef0 rounded-30 py-4 mb-5">
                        <div
                            ...
                            <div class="text-start text-sm-center text-lg-start">
                                ...
                                <p class="fw-light text-1415 pb-2 mb-5">O protocolo Short Message Peer to Peer (SMPP) é o protocolo que considera padrão da indústria para envio de SMS para o padrão da indústria de mensagens rede do provedor projetado para simplificar a integração de aplicativos de dados com as redes móveis sem fio.
                                    Além disso, trata-se do protocolo mais utilizado na indústria de telecomunicações para o intercâmbio de mensagens entre os SMSC (Short Message Service Centers) e ESME (External Short Messaging Entities). Este protocolo garante a entrega rápida de SMS, permitindo que vários pedidos de uma só vez.</p>
                                <a class="fs-18 fw-500 text-white bg-secondary rounded-4 text-decoration-none py-3 px-5" href="" role="button">Ver documentação</a>
                            </div>
